...
class Menu:
    ...
    def __init__(self, message, message_2, message_3, subtittle, screen):
        ...
        self.icon = pygame.transform.scale (ICON, (400,400))
        self. game_over = pygame.transform.scale (OVER, (360,50))
    ...
    def draw (self, screen, game):
        ...
        screen.blit(self.icon, (self.HALF_SCREEN_WIDTH - 200, self.HALF_SCREEN_HEIGHT -300))
        ...
        if game.death_count >0:
            screen.blit(self.game_over, (self.HALF_SCREEN_WIDTH - 180, self.HALF_SCREEN_HEIGHT -120))
